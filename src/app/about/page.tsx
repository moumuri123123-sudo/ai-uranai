      ...
      <div className="mx-auto max-w-3xl">
        ...
        <div className="text-foreground/80 space-y-8 text-sm leading-relaxed">
          ...
          <section className="border-border bg-surface rounded-xl border p-6">
            <h2 className="font-mincho text-gold mb-4 text-lg font-semibold">占処とは</h2>
            <p>
          ...
          {/* 占える占術 */}
          <section className="border-border bg-surface rounded-xl border p-6">
            <h2 className="font-mincho text-gold mb-4 text-lg font-semibold">占える占術</h2>
            <p className="mb-5">
            ...
            <ul className="grid grid-cols-1 gap-3 sm:grid-cols-2">
              {fortuneCards.map((card) => (
                <li key={card.href}>
                  <Link
                    href={card.href}
                    className={`border-border block h-full rounded-lg border bg-[#0a0408]/60 p-4 transition-all ${card.accent}`}
                  >
                    <p className="font-mincho text-gold text-base">{card.title}</p>
          ...
          {/* 運営者について */}
          <section className="border-border bg-surface rounded-xl border p-6">
            <h2 className="font-mincho text-gold mb-4 text-lg font-semibold">運営者について</h2>
            <p>
            ...
            <dl className="mt-5 space-y-2 text-xs">
              <div className="flex gap-4">
                <dt className="text-muted w-24 shrink-0">運営者</dt>
                <dd className="text-foreground/90">廣末 大輝</dd>
              </div>
              <div className="flex gap-4">
                <dt className="text-muted w-24 shrink-0">運営形態</dt>
                <dd className="text-foreground/90">個人運営</dd>
              </div>
              <div className="flex gap-4">
                <dt className="text-muted w-24 shrink-0">運営開始</dt>
          ...
          {/* 更新について */}
          <section className="border-border bg-surface rounded-xl border p-6">
            <h2 className="font-mincho text-gold mb-4 text-lg font-semibold">更新について</h2>
            <ul className="list-disc space-y-2 pl-5">
              ...
              <li>
                ...
                <Link
                  href="/blog"
                  className="text-warm hover:text-gold underline underline-offset-4"
                >
                  コラム
                </Link>
                でお知らせいたします。
          ...
          {/* 免責事項 */}
          <section className="border-border bg-surface rounded-xl border p-6">
            <h2 className="font-mincho text-gold mb-4 text-lg font-semibold">免責事項</h2>
            <p>
          ...
          {/* お問い合わせ */}
          <section className="border-border bg-surface rounded-xl border p-6">
            <h2 className="font-mincho text-gold mb-4 text-lg font-semibold">お問い合わせ</h2>
            <p>
            ...
            <p className="mt-4">
              <a
                ...
                className="font-mincho text-warm hover:text-gold text-base underline underline-offset-4 transition-colors"
              >
