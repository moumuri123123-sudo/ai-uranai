...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: 'https://uranaidokoro.com',
  },
  openGraph: {
    type: 'website',
    locale: 'ja_JP',
    ...
    siteName: '占処 AI占い',
    title: '占処 ── AI占い師',
    description: 'レトロな占い館へようこそ。最先端のAIが、古来の占術であなたの運命を紡ぎます。',
  },
  twitter: {
  ...
  return (
    <html lang="ja" className={`${zenMaruGothic.variable} ${shipporiMincho.variable}`}>
      ...
      <body className={`antialiased ${zenMaruGothic.className}`}>
        ...
        {/* フッター */}
        <footer className="border-border border-t bg-[#0a0408]">
          <div className="mx-auto max-w-6xl px-4 py-8">
            <div className="flex flex-col items-center gap-4 sm:flex-row sm:justify-between">
              <div className="text-center sm:text-left">
                <p className="font-yuji text-warm text-sm">占処 ── AI占い師</p>
