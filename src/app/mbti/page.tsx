...
const jsonLdData = JSON.stringify([
  webApplicationJsonLd({
    name: 'MBTI性格診断',
    description: '16タイプの性格診断であなたをAIが分析しアドバイスします',
    path: '/mbti',
  }),
    ...
    <div className="min-h-screen bg-[#0a0408]">
      ...
      <div className="mx-auto max-w-4xl px-4 py-12">
        ...
        <div className="mb-10 text-center">
          ...
          <p className="text-muted text-sm">あなたの性格タイプをAIが分析してアドバイスします</p>
        </div>
        ...
        <div className="border-border bg-surface/30 mt-12 rounded-xl border px-6 py-4">
          <p className="text-muted/70 text-xs leading-relaxed">
            ※
            この診断は簡易的なものであり、公式のMBTI&reg;診断ではありません。MBTI&reg;（Myers-Briggs
            Type Indicator）はThe Myers-Briggs
            Companyの登録商標です。正式な診断は認定プラクティショナーのもとで受けることをおすすめします。本診断はAIが生成したエンターテインメントであり、科学的根拠はありません。結果を過度に信頼したり、依存しないようご注意ください。
          </p>
        </div>
        {/* 広告 */}
