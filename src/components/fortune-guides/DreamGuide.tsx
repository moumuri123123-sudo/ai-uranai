    ...
    <article className="border-border mt-16 border-t pt-12">
      <div className="text-foreground/85 mx-auto max-w-3xl space-y-8 text-sm leading-relaxed">
        <header className="text-center">
          <h2 className="font-mincho text-neon-purple mb-3 text-2xl font-bold sm:text-3xl">
            夢占いを知る
          </h2>
        ...
        <section className="border-border bg-surface rounded-2xl border p-6">
          <h3 className="font-mincho text-neon-purple mb-4 text-lg font-semibold">夢占いとは</h3>
          <p>
        ...
        <section className="border-border bg-surface rounded-2xl border p-6">
          <h3 className="font-mincho text-neon-purple mb-4 text-lg font-semibold">夢の種類</h3>
          <div className="space-y-4">
            <div>
              <h4 className="text-gold mb-2 font-semibold">予知夢</h4>
              <p>
            ...
            <div>
              <h4 className="text-gold mb-2 font-semibold">警告夢</h4>
              <p>
                危険や注意すべき状況を知らせる夢。
            ...
            <div>
              <h4 className="text-gold mb-2 font-semibold">浄化夢</h4>
              <p>
            ...
            <div>
              <h4 className="text-gold mb-2 font-semibold">願望夢</h4>
              <p>
            ...
            <div>
              <h4 className="text-gold mb-2 font-semibold">ストレス夢</h4>
              <p>
                日常の疲れや緊張がそのまま反映される夢。
        ...
        <section className="border-border bg-surface rounded-2xl border p-6">
          <h3 className="font-mincho text-neon-purple mb-4 text-lg font-semibold">
            よく見る夢の象徴
          </h3>
          <div className="space-y-4">
            <div>
              <h4 className="text-gold mb-2 font-semibold">落ちる夢</h4>
              <p>
            ...
            <div>
              <h4 className="text-gold mb-2 font-semibold">追われる夢</h4>
              <p>
            ...
            <div>
              <h4 className="text-gold mb-2 font-semibold">歯が抜ける夢</h4>
              <p>
            ...
            <div>
              <h4 className="text-gold mb-2 font-semibold">空を飛ぶ夢</h4>
              <p>
            ...
            <div>
              <h4 className="text-gold mb-2 font-semibold">水の夢</h4>
              <p>
        ...
        <section className="border-border bg-surface rounded-2xl border p-6">
          ...
          <ul className="list-disc space-y-2 pl-5">
            <li>
              <span className="text-gold font-semibold">枕元にメモを置く</span>
              ── 夢は目覚めて数分で急速に忘れてしまうもの。
              起きた瞬間に書き留められるよう、紙とペンやスマホを手の届く場所に置いておきましょう。
            </li>
            <li>
              <span className="text-gold font-semibold">夢日記をつける</span>
              ── 日付と一緒に夢の内容を記録していくと、自分がよく見るテーマや
              繰り返し現れるモチーフが見えてきます。心の変化を辿る手がかりにもなります。
            </li>
            <li>
              <span className="text-gold font-semibold">断片でも記録する</span>
              ── 全体のストーリーを思い出せなくても大丈夫。
              色・匂い・一言のセリフなど、印象に残った断片だけでも立派な手がかりになります。
            </li>
            <li>
              <span className="text-gold font-semibold">感情とセットで覚える</span>
        ...
        <section className="border-border bg-surface rounded-2xl border p-6">
          <h3 className="font-mincho text-neon-purple mb-4 text-lg font-semibold">関連する占い</h3>
          <ul className="flex flex-wrap gap-3">
            <li>
              <Link
                href="/tarot"
                className="border-border text-foreground/85 hover:border-neon-purple hover:text-neon-purple inline-block rounded-lg border bg-[#0a0408]/50 px-4 py-2 text-sm transition-colors"
              >
                タロット占い
              </Link>
            </li>
        ...
        <div className="text-muted text-center text-xs">
          <p>
            ...
            <Link
              href="/blog"
              className="text-gold hover:text-neon-purple mx-1 underline underline-offset-4"
            >
              コラム記事
            </Link>
