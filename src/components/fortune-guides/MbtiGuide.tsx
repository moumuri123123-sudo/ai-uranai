    ...
    <article className="border-border mt-16 border-t pt-12">
      <div className="text-foreground/85 mx-auto max-w-3xl space-y-8 text-sm leading-relaxed">
        <header className="text-center">
          <h2 className="font-mincho text-neon-cyan mb-3 text-2xl font-bold sm:text-3xl">
            MBTI®診断を知る
          </h2>
        ...
        <section className="border-border bg-surface rounded-2xl border p-6">
          <h3 className="font-mincho text-neon-cyan mb-4 text-lg font-semibold">MBTI®とは</h3>
          <p>
        ...
        <section className="border-border bg-surface rounded-2xl border p-6">
          <h3 className="font-mincho text-neon-cyan mb-4 text-lg font-semibold">4つの指標</h3>
          <div className="space-y-4">
            <div>
              <h4 className="text-gold mb-2 font-semibold">E（外向） / I（内向）</h4>
              <p>
            ...
            <div>
              <h4 className="text-gold mb-2 font-semibold">S（感覚） / N（直観）</h4>
              <p>
            ...
            <div>
              <h4 className="text-gold mb-2 font-semibold">T（思考） / F（感情）</h4>
              <p>
            ...
            <div>
              <h4 className="text-gold mb-2 font-semibold">J（判断） / P（知覚）</h4>
              <p>
        ...
        <section className="border-border bg-surface rounded-2xl border p-6">
          <h3 className="font-mincho text-neon-cyan mb-4 text-lg font-semibold">16タイプの概要</h3>
          <div className="space-y-4">
            <div>
              <h4 className="text-gold mb-2 font-semibold">分析家（NT群）</h4>
              <p>
            ...
            <div>
              <h4 className="text-gold mb-2 font-semibold">外交官（NF群）</h4>
              <p>
            ...
            <div>
              <h4 className="text-gold mb-2 font-semibold">番人（SJ群）</h4>
              <p>
            ...
            <div>
              <h4 className="text-gold mb-2 font-semibold">探検家（SP群）</h4>
              <p>
        ...
        <section className="border-border bg-surface rounded-2xl border p-6">
          <h3 className="font-mincho text-neon-cyan mb-4 text-lg font-semibold">
            MBTIを活かすコツ
          </h3>
          <ul className="list-disc space-y-2 pl-5">
            <li>
              <span className="text-gold font-semibold">自己理解の手がかりにする</span>
              ── タイプの説明を読んで「自分はこういう場面で力が出る」と気づけたら、
              日々の選択や休み方を自分に合った形に整えるヒントになります。
            </li>
            <li>
              <span className="text-gold font-semibold">他者との違いを認める</span>
              ── 家族や同僚が自分と違うタイプでも、そこには優劣ではなく個性があります。
              「相手はこう感じやすいのかも」と想像できると、対話の摩擦が和らぎます。
            </li>
            <li>
              <span className="text-gold font-semibold">キャリアの方向性を考える</span>
              ── 得意な情報処理や判断スタイルを知ると、働き方や役割の選び方にも活かせます。
              ただし可能性を狭めず、参考のひとつとして受け止めましょう。
            </li>
            <li>
              <span className="text-gold font-semibold">人間関係の橋渡しに使う</span>
        ...
        <section className="border-border bg-surface rounded-2xl border p-6">
          <h3 className="font-mincho text-neon-cyan mb-4 text-lg font-semibold">関連する占い</h3>
          <ul className="flex flex-wrap gap-3">
            <li>
              <Link
                href="/compatibility"
                className="border-border text-foreground/85 hover:border-neon-cyan hover:text-neon-cyan inline-block rounded-lg border bg-[#0a0408]/50 px-4 py-2 text-sm transition-colors"
              >
                相性占い
              </Link>
            </li>
