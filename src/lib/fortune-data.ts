...
export const tarotCards: TarotCard[] = [
  ...
  { name: '隠者', meaning: '内省、探求、真実', reversedMeaning: '孤立、閉じこもり、頑固' },
  {
    name: '運命の輪',
    meaning: '転機、幸運、チャンス',
    reversedMeaning: '不運、停滞、変化への恐れ',
  },
  { name: '正義', meaning: '公正、バランス、真実', reversedMeaning: '不公平、偏見、不正' },
  {
    name: '吊るされた男',
    meaning: '試練、忍耐、新たな視点',
    reversedMeaning: '無駄な犠牲、執着、徒労',
  },
  {
    name: '死神',
    meaning: '変容、再生、終わりと始まり',
    reversedMeaning: '停滞、恐怖、変化の拒否',
  },
...
export const zodiacSigns: Record<string, ZodiacSign> = {
  aries: {
    ...
    period: '3/21〜4/19',
    element: '火',
    traits: '情熱的で行動力があり、リーダーシップに優れる',
  },
  taurus: {
    name: '牡牛座',
    period: '4/20〜5/20',
    element: '地',
    traits: '忍耐強く穏やかで、美しいものを愛する',
  },
  gemini: {
    name: '双子座',
    period: '5/21〜6/21',
    element: '風',
    traits: '知的好奇心が旺盛で、コミュニケーション能力が高い',
  },
  cancer: {
    name: '蟹座',
    period: '6/22〜7/22',
    element: '水',
    traits: '感受性が豊かで、家庭や仲間を大切にする',
  },
  leo: {
    name: '獅子座',
    period: '7/23〜8/22',
    element: '火',
    traits: '華やかで自信に満ち、創造力に溢れる',
  },
  virgo: {
    name: '乙女座',
    period: '8/23〜9/22',
    element: '地',
    traits: '几帳面で分析力に優れ、人の役に立つことを喜ぶ',
  },
  libra: {
    name: '天秤座',
    period: '9/23〜10/23',
    element: '風',
    traits: 'バランス感覚に優れ、美的センスと社交性を持つ',
  },
  scorpio: {
    name: '蠍座',
    period: '10/24〜11/22',
    element: '水',
    traits: '洞察力が鋭く、深い情熱と集中力を持つ',
  },
  sagittarius: {
    name: '射手座',
    period: '11/23〜12/21',
    element: '火',
    traits: '冒険心が旺盛で、自由と知識を愛する',
  },
  capricorn: {
    name: '山羊座',
    period: '12/22〜1/19',
    element: '地',
    traits: '真面目で責任感が強く、着実に目標を達成する',
  },
  aquarius: {
    name: '水瓶座',
    period: '1/20〜2/18',
    element: '風',
    traits: '独創的で革新的、自由な精神と博愛の心を持つ',
  },
  pisces: {
    name: '魚座',
    period: '2/19〜3/20',
    element: '水',
    traits: '共感力が高く、想像力豊かでロマンチスト',
  },
};
...
export const mbtiTypes: Record<string, MbtiType> = {
  INTJ: {
    code: 'INTJ',
    name: '建築家',
    traits: '戦略的で独立心が強く、計画的に物事を進める完璧主義者',
    compatibleTypes: ['ENFP', 'ENTP'],
  },
  INTP: {
    code: 'INTP',
    name: '論理学者',
    traits: '知識欲が旺盛で革新的なアイデアを生み出す思索家',
    compatibleTypes: ['ENTJ', 'ENFJ'],
  },
  ENTJ: {
    code: 'ENTJ',
    name: '指揮官',
    traits: '決断力とリーダーシップに優れ、目標達成に全力を注ぐ',
    compatibleTypes: ['INTP', 'INFP'],
  },
  ENTP: {
    code: 'ENTP',
    name: '討論者',
    traits: '機知に富み、新しい挑戦と議論を楽しむ発明家タイプ',
    compatibleTypes: ['INTJ', 'INFJ'],
  },
  INFJ: {
    code: 'INFJ',
    name: '提唱者',
    traits: '理想主義で洞察力に優れ、人の成長を支援する',
    compatibleTypes: ['ENTP', 'ENFP'],
  },
  INFP: {
    code: 'INFP',
    name: '仲介者',
    traits: '豊かな想像力と深い共感力を持つ理想主義者',
    compatibleTypes: ['ENTJ', 'ENFJ'],
  },
  ENFJ: {
    code: 'ENFJ',
    name: '主人公',
    traits: 'カリスマ性があり、人を導き励ますことに喜びを感じる',
    compatibleTypes: ['INTP', 'INFP'],
  },
  ENFP: {
    code: 'ENFP',
    name: '広報運動家',
    traits: '情熱的で創造力豊か、人とのつながりを大切にする',
    compatibleTypes: ['INTJ', 'INFJ'],
  },
  ISTJ: {
    code: 'ISTJ',
    name: '管理者',
    traits: '責任感が強く誠実で、伝統と秩序を重んじる',
    compatibleTypes: ['ESFP', 'ESTP'],
  },
  ISFJ: {
    code: 'ISFJ',
    name: '擁護者',
    traits: '献身的で温かく、周囲の人を守ることに使命感を持つ',
    compatibleTypes: ['ESFP', 'ESTP'],
  },
  ESTJ: {
    code: 'ESTJ',
    name: '幹部',
    traits: '組織力と実行力に優れ、ルールと効率を重視する',
    compatibleTypes: ['ISFP', 'ISTP'],
  },
  ESFJ: {
    code: 'ESFJ',
    name: '領事官',
    traits: '社交的で面倒見がよく、調和とチームワークを大切にする',
    compatibleTypes: ['ISFP', 'ISTP'],
  },
  ISTP: {
    code: 'ISTP',
    name: '巨匠',
    traits: '冷静で実践的、問題解決能力と適応力に優れる',
    compatibleTypes: ['ESTJ', 'ESFJ'],
  },
  ISFP: {
    code: 'ISFP',
    name: '冒険家',
    traits: '感受性が豊かで芸術的センスを持つ自由な魂',
    compatibleTypes: ['ESTJ', 'ESFJ'],
  },
  ESTP: {
    code: 'ESTP',
    name: '起業家',
    traits: '行動力があり社交的、リスクを恐れずチャンスを掴む',
    compatibleTypes: ['ISTJ', 'ISFJ'],
  },
  ESFP: {
    code: 'ESFP',
    name: 'エンターテイナー',
    traits: '明るく陽気で、周囲を楽しませることが得意',
    compatibleTypes: ['ISTJ', 'ISFJ'],
  },
};
...
export const mbtiQuestions: MbtiQuestion[] = [
  ...
  },
  {
    ...
    axis: 'SN',
    choiceA: '細かくスケジュールを決める',
    choiceB: '大まかに決めてあとは気分で',
  },
  // T/F（思考/感情）: 3問
  {
    question: '友達が悩んでいるとき',
  ...
  },
  {
    question: '大事な決断をするとき',
    axis: 'TF',
    choiceA: '論理的にメリット・デメリットを分析',
    choiceB: '自分の気持ちや価値観を大切にする',
  },
  {
    question: '議論で意見が対立したら',
    axis: 'TF',
    choiceA: '正しさを追求したい',
    choiceB: '相手との関係を大事にしたい',
  },
  // J/P（判断/知覚）: 2問
  {
    question: '締め切りがあるとき',
    axis: 'JP',
    choiceA: '早めに取りかかって余裕を持つ',
    choiceB: 'ギリギリでもなんとかなる派',
  },
  {
    question: '予定が急に変わったら',
    axis: 'JP',
    choiceA: 'ちょっとストレスを感じる',
    choiceB: '臨機応変に楽しめる',
  },
];
...
export function generateMbtiReading(question: string, mbtiType?: string): string {
  ...
  const compatible = typeData.compatibleTypes
    .map((c) => `${c}（${mbtiTypes[c]?.name}）`)
    .join('、');
